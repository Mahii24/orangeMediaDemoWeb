import Apartment1 from "../image/apartment.jpeg";
import Apartment2 from "../image/apartment2.jpg";
...
const AprCarosuel = () => {
    ...
    return (
        <div className="textfontfamily ">
            <h3 className="mt-4 mb-3 text-center">Apartments in Banglore</h3>
